...
wss.on('connection', (ws) => {
    ...
    const onRefreshData = (entity)  => ws.send(JSON.stringify({ type: 'REFRESH_DATA',  data: entity }));
    ...
    logger.on('refresh_data', onRefreshData);
    ...
    ws.on('close', () => {
        ...
        logger.removeListener('refresh_data',  onRefreshData);
    });
});
