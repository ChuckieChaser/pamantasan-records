...
// --- Domains ---
export const CoordinatorRequestsActionSchema = z.enum(Object.keys(COORDINATOR_REQUESTS_ACTION));
export const CoordinatorRequestsStatusSchema = z.enum(Object.keys(COORDINATOR_REQUESTS_STATUS));
