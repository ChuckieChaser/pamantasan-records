...
const SettingsModal = ({ isOpen, onClose }) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Settings" className="w-[800px] h-[600px] max-w-full">
                            ...
                            <div>
                                ...
                                <div className="mt-4">
                                    <SelectField
                                        ...
                                        value={userSetting?.theme || 'SYSTEM'}
                            ...
                            <div>
                                ...
                                <div className="mt-4">
                                    <SelectField
                                        ...
                                        value={userSetting?.notification || 'ALL'}
